---
title: "Trading ETH based on Money Flow Indicator (MFI)"
...
Source: https://github.com/markziemann/cryptoblog/blob/main/mfi_trading_eth.Rmd
...
head(res2[order(-res2$mean),],20) %>% kbl(caption="highest mean ROI strategies") %>%  kable_paper("hover", full_width = F)
...
head(res2,20) %>% kbl(caption="highest overall ROI strategies") %>%  kable_paper("hover", full_width = F)
...
trades %>% kbl(caption="highest overall ROI strategy") %>%  kable_paper("hover", full_width = F)
