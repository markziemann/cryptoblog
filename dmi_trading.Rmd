...
head(res[order(-res$mean),],50)
#%>% kbl() %>%  kable_paper("hover", full_width = F)

head(res[order(-res$returns),],50)
#%>% kbl() %>%  kable_paper("hover", full_width = F)

res2 <- subset(res,trades<200)
...
plot(res[,2],res[,1],log="y", cex=2, pch=19,col="gray",
  xlab="num trades",ylab="fold returns")
text(res[,2],res[,1],labels=rownames(res),cex=1.5)
abline(h=hodl,col="red")
grid()

res2 <- c(0,0,res[,1])

plot(res2,pch=19,xlab="n interval (days)",ylab="fold return",main="DMI")
abline(h=hodl,col="red")
grid()

plot(res2+1,pch=19,xlim=c(1,50),xlab="n interval (days)",ylab="fold return",
  main="DMI",log="y")
abline(h=hodl,col="red")
grid()
...
grid()
text(res$mean,res$returns , cex=, labels=rownames(res))
abline(h=hodl,col="red")
