...
Source: https://github.com/markziemann/cryptoblog/blob/main/tsi_trading_4hr.Rmd
...
This analysis is conducted on the 4-hr.
...
Obtaining BTC historical data (4-hourly) from CoinMarketCap.com from June 2013 to present.
...
Here we can see the TSI over the past 730 periods, using the default settings.
