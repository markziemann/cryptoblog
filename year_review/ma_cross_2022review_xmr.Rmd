---
title: "<br>XMR MA/EMA cross 2022 review"
date: "`r Sys.Date()`"
---
...
vioplot(sma_yearly,ylab="trade ROI distribution",main="XMR daily SMA cross strategy")

yr <- sapply(sma_yearly,prod)
barplot(yr,ylab="yearly fold returns",main="XMR daily SMA cross strategy")
...
vioplot(ema_yearly,ylab="trade ROI distribution",main="XMR daily EMA cross strategy")

yr <- sapply(ema_yearly,prod)
barplot(yr,ylab="yearly fold returns",main="XMR daily EMA cross strategy")
text(x=(1:length(yr)*1.2)-0.4,y=yr*0.9,labels=signif(yr,2),cex=1.2)
abline(h=1,col="red",lty=2)
...
Subscribing to alerts costs 0.0005 XMR per year.
