...
Based on this we can do some filtering for mean>1.4 and returns>1e5.


```{r,filt2}

top <- subset(res,mean>1.14&returns>1e5)
...
message(paste("Selected DMI period:",best_n1,best_n2))
