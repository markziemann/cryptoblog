...
Nakamoto and the whitepaper describing the technical details underlying the 
Bitcoin software was released in 2008.
...
It is described as the internet of money as it is an open and global network.
Transactions cannot be censored and are irreversible.
Folks can open a bitcoin wallet on their computer or smart phone and begin 
...
and has been termed the "Byzantine Generals Problem".
...
their CPU time to "solve" the cryptographic SHA256 checksum (hash) of the block,
so that the hash starts with a certain number of zeros.
...
As of today, about 18 M of the total 21 M BTC have been mined.
...
"bear markets" with drawdowns of 80 to 90% as seen in 2014/2015 and 2018/2019.
...
Probably not, Gresham's law indicates that "hard" money will be driven out of
...
a pizza would be worth something like $500 M at today's rates.

Therefore BTC will find itself to be a way for savers to preserve their 
purchasing power over long time frames, say decades.
...
Some people say that cryptocurrencies are a ponzi scheme and that it is intrinsically
worthless because it is backed by nothing.
...
* divisibility: each coin can be divided into 100 M units, called satoshis.
...
meaning a Dollar could be redeemed for a stable unit of gold.
Since 1971, the US Dollar is a fiat currency, meaning it no longer represents a set unit of gold.
...
M2 money has expanded dramatically in recent years in order to stimulate the economy,
but this extra cash and extremely low interest rates have benefitted mostly the already wealthy
and are leading to ordinary workers losing substantial purchasing power.

That's right, the US Dollar is not backed by anything either, except perhaps the might of its
millitary.

It is interesting to see El Salvador recently declare bitcoin as legal tender and 
incorporate it as a legitimate part of its economy.
...
This is a "layer 2" system which allows for tranactions to occur off-chain.
...
El Salvador's adoption of bitcoin is an interesting experiment will encourage other small
...
keep their holdings in cold storage until regulations are improved, or will move to a more 
permissive juristiction.
Legistators will be able to contrast harsh and friendly stances on digital assets, it is possible that
juristictions friendly to digital currencies will see an influx of entrepreneurs and new investment
which will stimulate their economies in contrast to the brain drain and escape of capital from
restrictive juristictions.
...
involved.
Clearly the Ethereum network is a focus for cutting edge applications such as decentralised finance (defi) and 
non-fungible tokens (NFTs) which will innovate banking, finance and other aspects of
our life, but keep in mind that Ethereum is undergoing major upgrades such as moving
...
smart contract chains and it will likely end up as winner-take-all.
