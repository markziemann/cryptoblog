...
In 2009 the bitcoin network started, presumably by Satoshi running the Bitcoin
node software.
...
mitigate the possibility of participants trying to double spend their fund.
Also, there is the problem of many nodes of the network needing to agree on the
contents of a block.
This is a major problem which has plagued decentralised systems for a long while
...
This process of block confirmation occurs approximately every 10 minutes and the 
...
being traded by miners on exchanges and this results in short term scarcity and
...
involved.
Clearly the Ethereum network is a focus for cutting edge applications such as defi and 
