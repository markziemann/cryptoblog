---
title: "<br>Trading based on Directional Movement Index (DMI)"
author: "Mark Ziemann"
date: "`r Sys.Date()`"
---
...
Obtaining ETH historical data (weekly).
...
if ( ! file.exists("ethdat_weekly.txt") ) {

  download.file(URL,destfile="ethdat_weekly.txt")

}

ethdat <- fromJSON("ethdat_weekly.txt")
