...
[Source code](https://github.com/markziemann/cryptoblog/blob/main/ma_trading_4hr.Rmd)
...
Obtaining BTC historical data (4 hourly) from CoinMarketCap.com from July 2017 to present.

```{r,getdata}

mydate <- Sys.Date()-1

URL=paste("https://web-api.coinmarketcap.com/v1/cryptocurrency/ohlcv/historical?symbol=BTC&convert=USD&interval=4h&time_period=hourly&time_start=2017-06-01&time_end=",mydate,sep="")
...
Let's look back in time and trial SMA and EMA strategies with an interval from 3 to 1000 periods.
...
plot(x=myrange, y=res_sma$returns, pch=19,
  xlab="moving average interval (4h)",ylab="fold return",main="BTC daily SMA")
abline(h=hodl,col="red")
grid()

plot(x=myrange,y=res_sma$returns, pch=19,
  xlim=c(1,200),xlab="moving average interval (4h)",ylab="fold return",main="BTC daily SMA")
abline(h=hodl,col="red")
grid()

plot(x=myrange,y=res_ema$returns, pch=19,
  xlab="moving average interval (4h)",ylab="fold return",main="BTC daily EMA")
abline(h=hodl,col="red")
grid()

plot(x=myrange,y=res_ema$returns, pch=19,
  xlim=c(1,200),xlab="moving average interval (4h)",ylab="fold return",main="BTC daily EMA")
abline(h=hodl,col="red")
grid()
