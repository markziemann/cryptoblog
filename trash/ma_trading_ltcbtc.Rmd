...
URL=paste("https://web-api.coinmarketcap.com/v1/cryptocurrency/ohlcv/historical?symbol=LTC&convert=BTC&interval=daily&time_start=2013-06-01&time_end=",mydate,sep="")

if ( ! file.exists("ltcbtcdat.txt") ) {

  download.file(URL,destfile="ltcbtcdat.txt")

}

btcdat <- fromJSON("ltcbtcdat.txt")
...
plot(price$Close~as.Date(price$date),type="l",log="y",
  xlab="Date",ylab="price (BTC)",main=SMA_HEADER)
grid()
...
plot(price$Close~as.Date(price$date),type="l",log="y",
  xlab="Date",ylab="price (BTC)",main=EMA_HEADER)
grid()
lines(ma~ as.Date(price$date) ,col="red")
