...
if ( ! file.exists("Binance_ETHUSDT_1h.csv") ) {
  download.file(URL,destfile="Binance_ETHUSDT_1h.csv")
  tmp <- readLines("Binance_ETHUSDT_1h.csv")
  tmp <- tmp[-1]
  writeLines(tmp,"Binance_ETHUSDT_1h.csv")
}


dat <- read.csv("Binance_ETHUSDT_1h.csv",header=TRUE)
