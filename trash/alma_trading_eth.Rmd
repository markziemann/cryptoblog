...
if ( ! file.exists("ethdat.txt") ) {
  ...
  download.file("https://web-api.coinmarketcap.com/v1/cryptocurrency/ohlcv/historical?symbol=ETH&convert=USD&interval=daily&time_start=2013-06-01&time_end=2021-06-30",destfile="ethdat.txt")
...
plot(res_ema,pch=19,xlab="moving average interval (days)",ylab="fold return",main="ALMA")
abline(h=hodl,col="red")
grid()

plot(res_ema,pch=19,xlim=c(1,50),xlab="moving average interval (days)",ylab="fold return",main="ALMA")
abline(h=hodl,col="red")
grid()
...
nrow(trades)
prod(trades$diff)
EMA_HEADER=paste(best_ema,"day ALMA")
