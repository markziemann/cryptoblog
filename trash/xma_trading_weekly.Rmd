---
title: "<br>Trading BTC based on Weekly Moving Averages"
author: "Mark Ziemann"
date: "`r Sys.Date()`"
---
...
res_wma <- t(sapply(myrange,function(n) { wma(price,n,fee) } ) )
rownames(res_wma) <- myrange
res_evwma <- t(sapply(myrange,function(n) { evwma(price,n,fee) } ) )
rownames(res_evwma) <- myrange
res_zlema <- t(sapply(myrange,function(n) { zlema(price,n,fee) } ) )
rownames(res_zlema) <- myrange
res_vwap <- t(sapply(myrange,function(n) { vwap(price,n,fee) } ) )
rownames(res_vwap) <- myrange
res_hma <- t(sapply(myrange,function(n) { hma(price,n,fee) } ) )
rownames(res_hma) <- myrange
res_alma <- t(sapply(myrange,function(n) { alma(price,n,fee) } ) )
...
plot(rownames(res_sma),res_sma[,1],pch=19,xlim=c(1,50),xlab="moving average interval (weeks)",ylab="fold return",main="SMA")
abline(h=hodl,col="red")
grid()
...
plot(rownames(res_wma),res_wma[,1],pch=19,xlab="moving average interval (weeks)",ylab="fold return",main="WMA")
abline(h=hodl,col="red")
grid()

plot(rownames(res_evwma),res_evwma[,1],pch=19,xlab="moving average interval (weeks)",ylab="fold return",main="EVWMA")
abline(h=hodl,col="red")
grid()

plot(rownames(res_zlema),res_zlema[,1],pch=19,xlab="moving average interval (weeks)",ylab="fold return",main="ZLEMA")
abline(h=hodl,col="red")
grid()

plot(rownames(res_vwap),res_vwap[,1],pch=19,xlab="moving average interval (weeks)",ylab="fold return",main="VWAP")
abline(h=hodl,col="red")
grid()

plot(rownames(res_hma),res_hma[,1],pch=19,xlab="moving average interval (weeks)",ylab="fold return",main="HMA")
abline(h=hodl,col="red")
grid()

plot(rownames(res_hma),res_hma[,1],pch=19,xlim=c(1,50),xlab="moving average interval (weeks)",ylab="fold return",main="HMA")
abline(h=hodl,col="red")
grid()

plot(rownames(res_alma),res_alma[,1],pch=19,xlab="moving average interval (weeks)",ylab="fold return",main="ALMA")
abline(h=hodl,col="red")
grid()

plot(rownames(res_alma),res_alma[,1],pch=19,xlim=c(1,50),xlab="moving average interval (weeks)",ylab="fold return",main="ALMA")
abline(h=hodl,col="red")
grid()
...
DEMA_HEADER=paste(best_dema,"week exponential moving average")
...
dema_yearly <- dema_yearly[which(lapply(dema_yearly,length)>0)]
vioplot(dema_yearly)
