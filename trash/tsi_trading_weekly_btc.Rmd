---
title: "<br>Trading BTC based on the weekly True Strength Index (TSI)"
date: "`r Sys.Date()`"
---

[Source code](https://github.com/MDZanalytics/cryptoblog/blob/main/tsi_trading_weekly_btc.Rmd)
...
head(res4) %>% kbl() %>%  kable_styling("hover", full_width = F)
