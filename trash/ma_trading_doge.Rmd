...
URL=paste("https://web-api.coinmarketcap.com/v1/cryptocurrency/ohlcv/historical?symbol=DOGE&convert=USD&interval=daily&time_start=2013-06-01&time_end=",mydate,sep="")

if ( ! file.exists("dogedat.txt") ) {

  download.file(URL,destfile="dogedat.txt")

}

dat <- fromJSON("dogedat.txt")
