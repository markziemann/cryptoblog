...
Obtaining XRP historical data (daily).

```{r,getdata}

mydate <- Sys.Date()-1

URL=paste("https://web-api.coinmarketcap.com/v1/cryptocurrency/ohlcv/historical?symbol=XRP&convert=USD&interval=daily&time_start=2013-09-01&time_end=",mydate,sep="")

if ( ! file.exists("xrpdat.txt") ) {

  download.file(URL,destfile="xrpdat.txt")

}

dat <- fromJSON("xrpdat.txt")
...
Hodling XRP over this period gave a 378 fold return.
