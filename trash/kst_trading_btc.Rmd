---
title: "<br>Trading BTC based on the Know Sure Thing (KST) indicator"
author: "Mark Ziemann https://mdz-analytics.com"
date: "`r Sys.Date()`"
---

[Source code](https://github.com/markziemann/cryptoblog/blob/main/kst_trading_btc.Rmd)
...
mykst <- function(price,nScale=1,nrocScale=1,nSig=9,fee=0.002) {
...
message(paste("Selected n1 period:",best_nScale))
message(paste("Selected n2 period:",best_nrocScale))
...
Here using the KST we have a strategy which scored 9x hodl returns which is superior to the best directional movement indicator
