---
title: "Trading XMR based on MA and EMAs"
date: "`r Sys.Date()`"
---

[Source code](https://github.com/MDZanalytics/cryptoblog/blob/main/ma_trading_xmr2.Rmd)
...
Obtaining XMR historical data (daily) from CoinMarketCap.com from August 2015 to present.

```{r,getdata}

mydate <- Sys.Date()-1

URL=paste("https://web-api.coinmarketcap.com/v1/cryptocurrency/ohlcv/historical?symbol=XMR&convert=USD&interval=daily&time_start=2014-07-01&time_end=",mydate,sep="")
...
XMR has appreciated a lot since 2013! 
...
plot(x=myrange, y=res_sma$returns, pch=19,
  xlab="moving average interval (days)",ylab="fold return",main="XMR daily SMA")
abline(h=hodl,col="red")
grid()

plot(x=myrange,y=res_sma$returns, pch=19,
  xlim=c(1,50),xlab="moving average interval (days)",ylab="fold return",main="XMR daily SMA")
abline(h=hodl,col="red")
grid()

plot(x=myrange,y=res_ema$returns, pch=19,
  xlab="moving average interval (days)",ylab="fold return",main="XMR daily EMA")
abline(h=hodl,col="red")
grid()

plot(x=myrange,y=res_ema$returns, pch=19,
  xlim=c(1,50),xlab="moving average interval (days)",ylab="fold return",main="XMR daily EMA")
abline(h=hodl,col="red")
grid()
...
plot(res_sma$mean,res_sma$returns, main="XMR daily SMA",
...
plot(res_ema$mean,res_ema$returns, main="XMR daily EMA",
  xlab="mean ROI",ylab="total ROI",cex=2,pch=19,col="gray")
grid()
...
* How does it compare to BTC and ETH?

* How do returns change over the years?
