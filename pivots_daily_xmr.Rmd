...
mydate <- Sys.Date()-1
URL=paste("https://web-api.coinmarketcap.com/v1/cryptocurrency/ohlcv/historical?symbol=XMR&convert=USD&time_period=hourly&interval=4h&time_start=2021-01-01&time_end=",mydate,sep="")
