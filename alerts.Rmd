...
6. Double RSI: [BTC](https://mdz-analytics.com/crypto/rsi2trading.html) n1=43, n2=112;
...
nFastk = 17, nFastD = 57, smooth = 6

```{r,btc_stoch,fig.height=10,fig.width=8}

sto <- stoch(HLC(price), nFastK=17 , nFastD=57 , nSlowD=57 , bounded = TRUE, smooth=6)
...
rsi2 <- RSI(price$close,n=112,maType=EMA)
...
nFastk = 20, nFastD = 47, smooth = 5

```{r,eth_stoch,fig.height=10,fig.width=8}

sto <- stoch(HLC(price), nFastK=20 , nFastD=47 , nSlowD=47 , bounded = TRUE, smooth=5)
