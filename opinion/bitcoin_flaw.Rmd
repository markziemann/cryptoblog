...
What about your credit or debit card, which is compulsory for you eBay or Amazon purchase?
...
where it reveals too much of your personal information to transaction partners.
It doesn't sound that useful does it?

That's why narrative around Bitcoin has changed from "p2p cash" to  "digital gold", so you 
...
If you purchase coins from an exchange, of course they know how much you have bought
over the years.
...
come under scrutiny from governments and their external contractors.
...
"manually" tracing funds, like you might browse a spreadsheet, it is no match against 
automated software tools that are specifically designed to flag specific transactions. 
...
If this occurs over a a centralized exchange that checks the legitimacy of coins when 
...
privacy preserving crypto), but those Monero funds were not tracable once they were withdrawn
from exchanges.
...
One day that information might be used by bad actors, to deanonymise wallets and target 
individuals.
...
Some truckers were against this move, so they used their vehicles to clog up inner Ottowa, 
...
Furthermore, as the protest were deemed illegal, the owners of the wallets who made those 
...
water is potentially troubling.
...
If you wanted to buy something deeply personal, like a medicine, psychological therapy, 
"adult" toy, I'm sure you would like to keep that information private.
...
by employers and merchants against persons based on their previous transactions.
...
In the case of the government, they might freeze your regular back account, or seize your 
house.
...
problem of privacy.
Indeed, privacy protecting crytos occupy an extremely small portion of this market - at about 
...
to a persons [social credit score](https://sociable.co/government-and-policy/chinas-digital-currency-help-ccp-punish-coerce-citizens-social-credit-system-cnas/).

Certainly the central banks *might* prevent sharing this data to third parties, but so long as
such a dataset exists it will be a huge honeypot that will attract hackers who will try to 
sell this information on the black market.
...
relatively more than those mined with energy from fossil fuels.
...
censor transactions of certain individuals.
...
changes is implemented is extremely slow and incremental.
This slow pace makes sense, as the developers want to ensure that BTC is a reliable system, 
as it supports billions in funds from millions of users.

This slow an incremental development process means that huge changes in blockchain structure 
...
transactions, there would be a major regulatory crack-down with exchanges delisting it, as 
has been [experienced by privacy coins in Western countries](https://cointelegraph.com/news/australian-exchanges-delist-privacy-coins-amid-chainalysis-integration).
Were this to happen, then it is likely that the value would tank dramatically, which would 
spell disaster for folks using BTC as a savings vehicle.
So there is a financial incentive for the BTC developer team to never implement meaningful 
...
top-tier cryptos in their popularity and in their market cap, however disruption like this is 
...
So how are privacy preserving cryptos going to rise to supremecy?
...
about the importance of cryto privacy.
...
I see a day ten years from now, when privacy protecting cryptos become the standard for 
commerce, smart contracts and investment.
But for this to happen we first need to recognise that privacy is a human right.
We need to get back to the roots of the cypherpunk movement which values freedoms over gains.
We will need to fight back against
