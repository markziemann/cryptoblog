---
title: "Trading TICKER based on the Know Sure Thing (KST) indicator"
date: "`r Sys.Date()`"
---

[Source code](https://github.com/MDZanalytics/cryptoblog/blob/main/coin_script/kst_trading_xx.Rmd)
...
kst_dat <- c("indicator"="KST",
  "parameter"=paste(best_nScale,best_nrocScale,best_nSigs,sep=",")  ,
...
write.table(t(kst_dat),file=filename,append=TRUE,col.names=FALSE,row.names=FALSE)
