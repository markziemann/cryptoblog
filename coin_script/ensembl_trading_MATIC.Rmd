---
title: "Trading MATIC based on indicator ensembles"
date: "`r Sys.Date()`"
---
...
URL=paste("https://web-api.coinmarketcap.com/v1/cryptocurrency/ohlcv/historical?symbol=MATIC&convert=USD&interval=daily&time_start=2013-06-01&time_end=",mydate,sep="")
...
params <- read.table("MATIC_dat.txt", header=TRUE)
...
filename <- paste("MATIC","_dat.txt",sep="")
