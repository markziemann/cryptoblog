---
title: "Trading TON based on indicator ensembles"
date: "`r Sys.Date()`"
---
...
URL=paste("https://web-api.coinmarketcap.com/v1/cryptocurrency/ohlcv/historical?symbol=TON&convert=USD&interval=daily&time_start=2013-06-01&time_end=",mydate,sep="")
...
params <- read.table("TON_dat.txt", header=TRUE)
...
filename <- paste("TON","_dat.txt",sep="")
