---
title: "Trading TRX based on indicator ensembles"
date: "`r Sys.Date()`"
---
...
URL=paste("https://web-api.coinmarketcap.com/v1/cryptocurrency/ohlcv/historical?symbol=TRX&convert=USD&interval=daily&time_start=2013-06-01&time_end=",mydate,sep="")
...
params <- read.table("TRX_dat.txt", header=TRUE)
...
filename <- paste("TRX","_dat.txt",sep="")
