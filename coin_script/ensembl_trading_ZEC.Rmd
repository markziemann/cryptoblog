---
title: "Trading ZEC based on indicator ensembles"
...
URL=paste("https://web-api.coinmarketcap.com/v1/cryptocurrency/ohlcv/historical?symbol=ZEC&convert=USD&interval=daily&time_start=2013-06-01&time_end=",mydate,sep="")
...
params <- read.table("ZEC_dat.txt", header=TRUE)
...
filename <- paste("ZEC","_dat.txt",sep="")
