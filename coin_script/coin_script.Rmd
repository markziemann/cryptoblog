...
[Source code](https://github.com/markziemann/cryptoblog/blob/main/coin_script.Rmd)
...
coinfun <- function(TICKER) {
  ...
  CMD=paste("scp -r -P 21098", TICKER  , "mdzascfs@mdz-analytics.com:/home/mdzascfs/public_html/altcoins")
  system(CMD)
...
for ( TICKER in TICKERS ) {
  ...
  if ( is.na(LAST_UPDATE_TIME) ) { LAST_UPDATE_TIME=100  }
  if ( LAST_UPDATE_TIME >12 ) {
