...
EXCLUDE <- c("USDT","USDC","BUSD","UST","TUSD","USDP","USDN","DAI","FEI",
...
head(all_indicators[order(-all_indicators$totalROI),],50) %>% kbl(caption="top 50 indicators by return") %>%  kable_styling()
