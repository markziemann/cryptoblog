---
title: "Trading XTZ based on indicator ensembles"
date: "`r Sys.Date()`"
---
...
URL=paste("https://web-api.coinmarketcap.com/v1/cryptocurrency/ohlcv/historical?symbol=XTZ&convert=USD&interval=daily&time_start=2013-06-01&time_end=",mydate,sep="")
...
params <- read.table("XTZ_dat.txt", header=TRUE)
...
filename <- paste("XTZ","_dat.txt",sep="")
