---
title: "<br>Trading XMR based on Directional Movement Index (DMI)"
date: "`r Sys.Date()`"
---

[Source code](https://github.com/MDZanalytics/cryptoblog/blob/main/dmi_trading_xmr.Rmd)
...
The DMI gives a moderately successful indicator that is simple to implement.
