---
title: "Trading BTC based on indicator ensembles"
...
res <- res[,c(4,2,1,3)]
res %>% kbl(caption="backtesting results with minimum postive indicators") %>%  kable_paper("hover", full_width = F)
...
head(resdf,20) %>% kbl(caption="top performing indicator combinations") %>%  kable_paper("hover", full_width = F)

tail(resdf,20) %>% kbl(caption="worst performing indicator combinations") %>%  kable_paper("hover", full_width = F)
...
indicators <- indicators[,2:ncol(indicators)]
...
trades %>% kbl(caption="top strategy trade history") %>%  kable_paper("hover", full_width = F)
