...
head(res2[order(-res2$mean),],20) %>% kbl(caption="highest mean ROI strategies (unadjusted)") %>%  kable_paper("hover", full_width = F)

head(res2[order(-res2$mean_adjusted),],20) %>% kbl(caption="highest mean ROI strategies (adjusted)") %>%  kable_paper("hover", full_width = F)
...
head(res2[order(-res2$returns),],20) %>% kbl(caption="highest total ROI strategies (unadjusted)") %>%  kable_paper("hover", full_width = F)

head(res2[order(-res2$returns_adjusted),],20) %>% kbl(caption="highest total ROI strategies (adjusted)") %>%  kable_paper("hover", full_width = F)
...
head(res3[order(-res3$returns),],20) %>% kbl(caption="highest total ROI strategies with <200 trades (unadjusted)") %>%  kable_paper("hover", full_width = F)

head(res3[order(-res3$returns_adjusted),],20) %>% kbl(caption="highest total ROI strategies with <200 trades (adjusted)") %>%  kable_paper("hover", full_width = F)
...
res5 <- head(res5,20)
res5 %>% kbl(caption="Best total ROI strategies with mean ROI>1.08 (adjusted)") %>%  kable_paper("hover", full_width = F)
...
head(res3,10) %>% kbl(caption="highest returning strategies with fewer than 200 trades(adjusted)") %>%  kable_paper("hover", full_width = F)
