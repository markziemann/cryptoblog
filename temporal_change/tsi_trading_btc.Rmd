...
Source: https://github.com/MDZanalytics/cryptoblog/blob/main/tsi_trading.Rmd
...
head(res2[order(-res2$mean),],20) %>% kbl(caption="Highest mean ROI TSI strategy (unadjusted)") %>%  kable_styling("hover", full_width = F)

head(res2[order(-res2$mean_adjusted),],20) %>% kbl(caption="Highest mean ROI TSI strategy (adjusted)") %>%  kable_styling("hover", full_width = F)
...
head(res2[order(-res2$returns),],20) %>% kbl(caption="Highest ROI TSI strategy (unadjusted)") %>%  kable_styling("hover", full_width = F)

head(res2[order(-res2$returns_adjusted),],20) %>% kbl(caption="Highest ROI TSI strategy (unadjusted)") %>%  kable_styling("hover", full_width = F)
...
head(res3,20) %>% kbl(caption="Highest ROI TSI strategy with mean>1.1 (adjusted)") %>%  kable_styling("hover", full_width = F)
...
head(res2[order(-res2$returns),],20) %>% kbl(caption="Highest overall ROI TSI strategy (unadjusted)") %>%  kable_styling("hover", full_width = F)

head(res2[order(-res2$returns_adjusted),],20) %>% kbl(caption="Highest overall ROI TSI strategy (unadjusted)") %>%  kable_styling("hover", full_width = F)
