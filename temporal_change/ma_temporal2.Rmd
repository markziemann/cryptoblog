...
price0[c(1:5,(nrow(price0)-5):nrow(price0)),]  %>% kbl(caption="period0 range") %>%  kable_styling("hover", full_width = F)
price1[c(1:5,(nrow(price1)-5):nrow(price1)),]  %>% kbl(caption="period1 range") %>%  kable_styling("hover", full_width = F)
...
res_sma %>% kbl(caption="SMA trading strategies in period 0 and 1") %>%  kable_styling("hover", full_width = F)
...
res_ema %>% kbl(caption="EMA trading strategies in period 0 and 1") %>%  kable_styling("hover", full_width = F)
