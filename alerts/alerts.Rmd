...
[ETH](https://mdz-analytics.com/crypto/ma_cross_eth.html) 12/21 day.
...
[ETH](https://mdz-analytics.com/crypto/tsi_trading_eth.html) n1=97, n2=9, n.signal=19.

5. Stochastic oscillator (stoch): [BTC](https://mdz-analytics.com/crypto/stoch_trading.html) nFastK=16, nFastD=54, smooth=6;
...
tsi <- TSI(price$close , n.first = 81, n.second = 21, n.signal = 5 )
colnames(tsi) <- c("tsi","sig")
...
tsi <- TSI(price$close , n.first = 56, n.second = 39, n.signal = 9 )
colnames(tsi) <- c("tsi","sig")
...
if ( xhv_signal != "NONE") {
  MYNOTE <- paste("XHV is flashing a ", xhv_signal,
   ". Visit https://mdz-analytics.com/crypto/alerts.html for the details")
