...
[Source code](https://github.com/MDZanalytics/cryptoblog/blob/main/alerts/alerts.Rmd)
...
* Know Sure Thing (KST) indicator [BTC](https://mdz-analytics.com/crypto/kst_trading_btc.html), [ETH](https://mdz-analytics.com/crypto/kst_trading_eth.html) and
[XMR](https://mdz-analytics.com/crypto/kst_trading_xmr.html).

* Ensemble indicator [BTC](https://mdz-analytics.com/crypto/ensembl_trading_btc.html),
[ETH](https://mdz-analytics.com/crypto/ensembl_trading_eth.html) and
[XMR](https://mdz-analytics.com/crypto/ensembl_trading_xmr.html).
...
```{r, btc_sma_plot,fig.height=6,fig.width=6}
...
```{r, btc_ema_plot,fig.height=6,fig.width=6}
...
```{r, btc_cross_plot,fig.height=6,fig.width=6}
...
```{r, btc_ema_cross_plot,fig.height=6,fig.width=6}
...
```{r,btc_dmi,fig.height=7,fig.width=6}
...
```{r,btc_dmi_plot,fig.height=7,fig.width=6}
...
```{r,btc_tsi,fig.height=7,fig.width=6}
...
```{r,btc_tsi_plot,fig.height=7,fig.width=6}
...
```{r,btc_stoch,fig.height=7,fig.width=6}
...
```{r,btc_stoch_plot,fig.height=7,fig.width=6}
...
```{r,btc_rsi1,fig.height=7,fig.width=6}
...
```{r,btc_rsi_plot,fig.height=7,fig.width=6}
...
```{r,btc_dc1,fig.height=7,fig.width=6}
...
```{r,btc_dc_plot,fig.height=7,fig.width=6}
...
```{r,btc_kst,fig.height=7,fig.width=6}
...
```{r,btc_kst_plot,fig.height=7,fig.width=6}
...
```{r,btc_ens1,fig.height=7,fig.width=6}
...
system("wget https://mdz-analytics.com/crypto/alerts.html -O alerts.html")
prev_html <- readLines("alerts.html")
...
```{r, eth_sma_plot,fig.height=6,fig.width=6}
...
```{r, eth_ema_plot,fig.height=6,fig.width=6}
...
```{r, eth_cross_plot,fig.height=6,fig.width=6}
...
```{r, eth_ema_cross_plot,fig.height=6,fig.width=6}
...
```{r,eth_dmi,fig.height=7,fig.width=6}
...
```{r, eth_dmi_plot,fig.height=7,fig.width=6}
...
```{r,eth_tsi,fig.height=7,fig.width=6}
...
```{r,eth_tsi_plot,fig.height=7,fig.width=6}
...
```{r,eth_stoch,fig.height=7,fig.width=6}
...
```{r,eth_stoch_plot,fig.height=7,fig.width=6}
...
```{r,eth_rsi1,fig.height=7,fig.width=6}
...
```{r,eth_rsi_plot,fig.height=7,fig.width=6}
...
```{r,eth_dc1,fig.height=7,fig.width=6}
...
```{r,eth_dc_plot,fig.height=7,fig.width=6}
...
```{r,eth_kst,fig.height=7,fig.width=6}
...
```{r,eth_kst_plot,fig.height=7,fig.width=6}
...
This is a combination of a number of n=y indicators, where x/y
are a buy/sell threshold.

```{r,eth_ens1,fig.height=7,fig.width=6}
...
```{r, xmr_sma_plot,fig.height=6,fig.width=6}
...
```{r, xmr_ema_plot,fig.height=6,fig.width=6}
...
```{r, xmr_cross_plot,fig.height=6,fig.width=6}
...
```{r, xmr_ema_cross_plot,fig.height=6,fig.width=6}
...
```{r,xmr_dmi,fig.height=7,fig.width=6}
...
```{r,xmr_dmi_plot,fig.height=7,fig.width=6}
...
```{r,xmr_tsi,fig.height=7,fig.width=6}
...
```{r,xmr_tsi_plot,fig.height=7,fig.width=6}
...
```{r,xmr_stoch,fig.height=7,fig.width=6}
...
```{r,xmr_stoch_plot,fig.height=7,fig.width=6}
...
```{r,xmr_rsi1,fig.height=7,fig.width=6}
...
```{r,xmr_rsi_plot,fig.height=7,fig.width=6}
...
```{r,xmr_dc1,fig.height=7,fig.width=6}
...
```{r,xmr_dc_plot,fig.height=7,fig.width=6}
...
```{r,xmr_kst,fig.height=7,fig.width=6}
...
```{r,xmr_kst_plot,fig.height=7,fig.width=6}
...
```{r,xmr_ens1,fig.height=7,fig.width=6}
