...
if (today_signal==TRUE) {
 ...
 system("sed -i 's/BTC_SMACROSS_COL/green/' ../index1.html")
} else {
...
if (today_signal==TRUE) {
 ...
 system("sed -i 's/BTC_EMACROSS_COL/green/' ../index1.html")
} else {
...
if (today_signal==TRUE) {
 ...
 system("sed -i 's/ETH_SMACROSS_COL/green/' ../index1.html")
} else {
...
if (today_signal==TRUE) {
 ...
 system("sed -i 's/ETH_EMACROSS_COL/green/' ../index1.html")
} else {
...
if (today_signal==TRUE) {
 ...
 system("sed -i 's/XMR_SMACROSS_COL/green/' ../index1.html")
} else {
...
if (today_signal==TRUE) {
 ...
 system("sed -i 's/XMR_EMACROSS_COL/green/' ../index1.html")
} else {
