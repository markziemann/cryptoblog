---
title: "Daily trade alerts for BTC, ETH and XMR"
...
1. Simple and exponential moving averages for [BTC](https://mdz-analytics.com/crypto/ma_trading_btc.html),
[ETH](https://mdz-analytics.com/crypto/ma_trading_eth.html) and
[XMR](https://mdz-analytics.com/altcoins/XMR/ma_trading_XMR.html).

2. Moving average crosses for [BTC](https://mdz-analytics.com/crypto/ma_cross_btc.html),
[ETH](https://mdz-analytics.com/crypto/ma_cross_eth.html) and
[XMR](https://mdz-analytics.com/altcoins/XMR/ma_cross_XMR.html).

3. Directional movement index (DMI) for [BTC](https://mdz-analytics.com/crypto/dmi_trading_btc.html),
[ETH](https://mdz-analytics.com/crypto/dmi_trading_eth.html) and
[XMR](https://mdz-analytics.com/altcoins/XMR/dmi_trading_XMR.html).

4. True strength index (TSI) for [BTC](https://mdz-analytics.com/crypto/tsi_trading_btc.html),
[ETH](https://mdz-analytics.com/crypto/tsi_trading_eth.html) and
[XMR](https://mdz-analytics.com/altcoins/XMR/tsi_trading_XMR.html).

5. Stochastic oscillator (stoch) for [BTC](https://mdz-analytics.com/crypto/stoch_trading_btc.html),
...
6. Double RSI and [BTC](https://mdz-analytics.com/crypto/rsi2trading_btc.html),
...
if (today_signal==TRUE) {
 ...
 system("sed -i 's/BTC_EMA_COL/green/' ../index1.html")
} else {
...
if (today_signal==TRUE) {
 system("sed -i 's/BTC_EMA_CROSS_DAILY/BULLISH/' ../index1.html")
 system("sed -i 's/BTC_EMA_CROSS_COL/green/' ../index1.html")
} else {
 system("sed -i 's/BTC_EMA_CROSS_DAILY/BEARISH/' ../index1.html")
 system("sed -i 's/BTC_EMA_CROSS_COL/red/' ../index1.html")
}
...
if (today_signal==TRUE) {
 ...
 system("sed -i 's/ETH_EMA_COL/green/' ../index1.html")
} else {
...
if (today_signal==TRUE) {
 system("sed -i 's/ETH_EMA_CROSS_DAILY/BULLISH/' ../index1.html")
 system("sed -i 's/ETH_EMA_CROSS_COL/green/' ../index1.html")
} else {
 system("sed -i 's/ETH_EMA_CROSS_DAILY/BEARISH/' ../index1.html")
 system("sed -i 's/ETH_EMA_CROSS_COL/red/' ../index1.html")
}
...
params %>% kbl(caption="XMR optimised backtested parameters") %>%  kable_paper("hover", full_width = F)
...
if (today_signal==TRUE) {
 ...
 system("sed -i 's/XMR_SMA_COL/green/' ../index1.html")
} else {
...
if (today_signal==TRUE) {
 ...
 system("sed -i 's/XMR_EMA_COL/green/' ../index1.html")
} else {
...
if (today_signal==TRUE) {
 system("sed -i 's/XMR_SMA_CROSS_DAILY/BULLISH/' ../index1.html")
 system("sed -i 's/XMR_SMA_CROSS_COL/green/' ../index1.html")
} else {
 system("sed -i 's/XMR_SMA_CROSS_DAILY/BEARISH/' ../index1.html")
 system("sed -i 's/XMR_SMA_CROSS_COL/red/' ../index1.html")
}
...
if (today_signal==TRUE) {
 system("sed -i 's/XMR_EMA_CROSS_DAILY/BULLISH/' ../index1.html")
 system("sed -i 's/XMR_EMA_CROSS_COL/green/' ../index1.html")
} else {
 system("sed -i 's/XMR_EMA_CROSS_DAILY/BEARISH/' ../index1.html")
 system("sed -i 's/XMR_EMA_CROSS_COL/red/' ../index1.html")
}
...
if (today_signal==TRUE) {
 ...
 system("sed -i 's/XMR_DMI_COL/green/' ../index1.html")
} else {
...
if (today_signal==TRUE) {
 ...
 system("sed -i 's/XMR_TSI_COL/green/' ../index1.html")
} else {
...
if (today_signal==TRUE) {
 ...
 system("sed -i 's/XMR_STOCH_COL/green/' ../index1.html")
} else {
...
if (today_signal==TRUE) {
 ...
 system("sed -i 's/XMR_RSI_COL/green/' ../index1.html")
} else {
