---
title: "Daily trade alerts for XHV"
...
Source: https://github.com/MDZanalytics/cryptoblog/blob/main/alerts_XHV.Rmd
...
<a class="pushbullet-subscribe-widget" data-channel="xhv_signal" data-widget="button" data-size="small"></a>
...
params <- read.table("https://mdz-analytics.com/altcoins/XHV/XHV_dat.txt", header=TRUE)
...
Obtaining XHV price data (daily) for the last 300 days.
...
# system("sed -i 's/XHV_SMA_DAILY/BULLISH/' index1.html")
# system("sed -i 's/XHV_SMA_COL/green/' index1.html")
#} else {
# system("sed -i 's/XHV_SMA_DAILY/BEARISH/' index1.html")
# system("sed -i 's/XHV_SMA_COL/red/' index1.html")
#}
...
```{r, xhv_sma_plot,fig.height=8,fig.width=8}
...
#if (today_signal==TRUE) {
# system("sed -i 's/XHV_SMA_CROSS_DAILY/BULLISH/' index1.html")
# system("sed -i 's/XHV_SMA_CROSS_COL/green/' index1.html")
#} else {
# system("sed -i 's/XHV_SMA_CROSS_DAILY/BEARISH/' index1.html")
# system("sed -i 's/XHV_SMA_CROSS_COL/red/' index1.html")
#}
...
```{r, xhv_cross_plot,fig.height=8,fig.width=8}
...
```{r,xhv_dmi,fig.height=10,fig.width=8}
...
#if (today_signal==TRUE) {
# system("sed -i 's/XHV_DMI_DAILY/BULLISH/' index1.html")
# system("sed -i 's/XHV_DMI_COL/green/' index1.html")
#} else {
# system("sed -i 's/XHV_DMI_DAILY/BEARISH/' index1.html")
# system("sed -i 's/XHV_DMI_COL/red/' index1.html")
#}
...
```{r,xhv_dmi_plot,fig.height=10,fig.width=8}
...
if ( xhv_signal != "NONE") {
  MYNOTE <- paste(MYNOTE,"XHV is flashing a ", xhv_signal,".")
}
...
```{r,xhv_tsi,fig.height=10,fig.width=8}
...
#if (today_signal==TRUE) {
# system("sed -i 's/XHV_TSI_DAILY/BULLISH/' index1.html")
# system("sed -i 's/XHV_TSI_COL/green/' index1.html")
#} else {
# system("sed -i 's/XHV_TSI_DAILY/BEARISH/' index1.html")
# system("sed -i 's/XHV_TSI_COL/red/' index1.html")
#}
...
```{r,xhv_tsi_plot,fig.height=10,fig.width=8}
...
```{r,xhv_stoch,fig.height=10,fig.width=8}
...
if (today_signal != previous_signal ) {
  if ( (today_signal == TRUE ) & (previous_signal == FALSE ) ) {
    xhv_signal="stoch BUY"
  }
  if ( (today_signal == FALSE ) & (previous_signal == TRUE ) ) {
    xhv_signal="stoch SELL"
  }
} else {
  xhv_signal <- "NONE"
}
...
#if (today_signal==TRUE) {
# system("sed -i 's/XHV_STOCH_DAILY/BULLISH/' index1.html")
# system("sed -i 's/XHV_STOCH_COL/green/' index1.html")
#} else {
# system("sed -i 's/XHV_STOCH_DAILY/BEARISH/' index1.html")
# system("sed -i 's/XHV_STOCH_COL/red/' index1.html")
#}
...
```{r,xhv_stoch_plot,fig.height=10,fig.width=8}
...
```{r,xhv_rsi1,fig.height=10,fig.width=8}
...
#if (today_signal==TRUE) {
# system("sed -i 's/XHV_RSI_DAILY/BULLISH/' index1.html")
# system("sed -i 's/XHV_RSI_COL/green/' index1.html")
#} else {
# system("sed -i 's/XHV_RSI_DAILY/BEARISH/' index1.html")
# system("sed -i 's/XHV_RSI_COL/red/' index1.html")
#}
...
```{r,xhv_rsi_plot,fig.height=10,fig.width=8}
...
if ( !is.null(MYNOTE) ) {
  MYNOTE <- paste(MYNOTE, ". Visit https://mdz-analytics.com/altcoins/XHV/alerts_XHV.html for the details")
