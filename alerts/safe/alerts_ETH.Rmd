---
title: "Daily trade alerts for ETH"
...
Source: https://github.com/MDZanalytics/cryptoblog/blob/main/alerts_ETH.Rmd
...
Obtaining ETH price data (daily) for the last 300 days.
...
if ( !is.null(MYNOTE) ) {
  MYNOTE <- paste(MYNOTE, ". Visit https://mdz-analytics.com/altcoins/ETH/alerts_ETH.html for the details")
