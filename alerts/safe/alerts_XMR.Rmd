---
title: "Daily trade alerts for XMR"
...
Source: https://github.com/MDZanalytics/cryptoblog/blob/main/alerts_XMR.Rmd
...
if ( xmr_signal != "NONE") {
  MYNOTE <- paste(MYNOTE,"XMR is flashing a ", xmr_signal,".")
}
...
if (today_signal != previous_signal ) {
  if ( (today_signal == TRUE ) & (previous_signal == FALSE ) ) {
    xmr_signal="stoch BUY"
  }
  if ( (today_signal == FALSE ) & (previous_signal == TRUE ) ) {
    xmr_signal="stoch SELL"
  }
} else {
  xmr_signal <- "NONE"
}
...
if ( !is.null(MYNOTE) ) {
  MYNOTE <- paste(MYNOTE, ". Visit https://mdz-analytics.com/altcoins/XMR/alerts_XMR.html for the details")
