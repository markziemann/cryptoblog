---
title: "<br>Daily trade alerts for XRP"
author: "Mark Ziemann https://mdz-analytics.com"
date: "`r Sys.Date()`"
---

[Source code](https://github.com/MDZanalytics/cryptoblog/blob/main/alerts_XRP.Rmd)

## Intro

In the backtesting analysis, I have established several different profitable strategies for timing entry/exits.
Visit the [XRP page](https://mdz-analytics.com/coins/XRP/) to see how these signals were identified.
...
```{r, xrp_ema_plot,fig.height=8,fig.width=8}
...
```{r, xrp_ema_cross_plot,fig.height=8,fig.width=8}
...
```{r,xrp_dc1,fig.height=10,fig.width=8}
...
```{r,xrp_dc_plot,fig.height=10,fig.width=8}
...
```{r,xrp_kst,fig.height=10,fig.width=8}
...
message(paste("XRP KST signal:",xrp_signal))

```

```{r,xrp_kst_plot,fig.height=10,fig.width=8}
...
if ( xrp_signal != "NONE") {
  MYNOTE <- paste(MYNOTE,"XRP KST signal is", xrp_signal,".")
}
...
```{r,xrp_ens1,fig.height=10,fig.width=8}
