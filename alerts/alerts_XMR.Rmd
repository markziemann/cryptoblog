---
title: "<br>Daily trade alerts for XMR"
author: "Mark Ziemann https://mdz-analytics.com"
date: "`r Sys.Date()`"
---

[Source code](https://github.com/MDZanalytics/cryptoblog/blob/main/alerts_XMR.Rmd)

## Intro

In the backtesting analysis, I have established several different profitable strategies for timing entry/exits.
Visit the [XMR page](https://mdz-analytics.com/coins/XMR/) to see how these signals were identified.
