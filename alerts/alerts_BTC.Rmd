---
title: "<br>Daily trade alerts for BTC"
author: "Mark Ziemann https://mdz-analytics.com"
date: "`r Sys.Date()`"
---

[Source code](https://github.com/MDZanalytics/cryptoblog/blob/main/alerts_BTC.Rmd)

## Intro

In the backtesting analysis, I have established several different profitable strategies for timing entry/exits.
Visit the [BTC page](https://mdz-analytics.com/coins/BTC/) to see how these signals were identified.
