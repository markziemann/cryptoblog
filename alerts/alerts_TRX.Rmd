...
If you would like to receive these signals in real-time, you can subscribe for 0.0005 TRX per year.
...
if ( trx_signal != "NONE") {
  MYNOTE <- paste("The TRX SMA signal is", trx_signal,
    ". Visit https://mdz-analytics.com/altcoins/TRX/alerts_TRX.html for the details")
...
if ( trx_signal != "NONE") {
  MYNOTE <- paste("The TRX SMA cross signal is", trx_signal,
    ". Visit https://mdz-analytics.com/altcoins/TRX/alerts_TRX.html for the details")
  pbPost("note", "Crypto Alert", MYNOTE)
}
...
DMI using a 32 day interval gives returns similar to than the SMA strategy.
...
if ( trx_signal != "NONE") {
  MYNOTE <- paste("TRX is flashing a ", trx_signal,
    ". Visit https://mdz-analytics.com/altcoins/TRX/alerts_TRX.html for the details")
  pbPost("note", "Crypto Alert", MYNOTE)
}
...
SImilar to the TSI, the stoch can pinpoint early changes in momentum.
