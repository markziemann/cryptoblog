---
title: "<br>Daily trade alerts for XHV"
author: "Mark Ziemann https://mdz-analytics.com"
date: "`r Sys.Date()`"
---

[Source code](https://github.com/MDZanalytics/cryptoblog/blob/main/alerts_XHV.Rmd)

## Intro

In the backtesting analysis, I have established several different profitable strategies for timing entry/exits.
Visit the [XHV page](https://mdz-analytics.com/coins/XHV/) to see how these signals were identified.
...
```{r, xhv_ema_plot,fig.height=8,fig.width=8}
...
```{r, xhv_ema_cross_plot,fig.height=8,fig.width=8}
...
```{r,xhv_dc1,fig.height=10,fig.width=8}
...
```{r,xhv_dc_plot,fig.height=10,fig.width=8}
...
```{r,xhv_kst,fig.height=10,fig.width=8}
...
message(paste("XHV KST signal:",xhv_signal))

```

```{r,xhv_kst_plot,fig.height=10,fig.width=8}
...
if ( xhv_signal != "NONE") {
  MYNOTE <- paste(MYNOTE,"XHV KST signal is", xhv_signal,".")
}
...
```{r,xhv_ens1,fig.height=10,fig.width=8}
