...
intervals from 4 days to 1000 periods.
...
plot(res$period,res$returns,pch=19,xlab="n periods",ylab="fold return",main="DMI")
abline(h=hodl,col="red")
grid()

plot(res$period,res$returns,pch=19,xlim=c(1,50),xlab="n periods",ylab="fold return",
  main="DMI",log="y")
abline(h=hodl,col="red")
grid()
