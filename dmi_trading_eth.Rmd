...
The 45 day interval gives a high probability of high returns but occurs rarely.
...
plot(dmi.adx[,1] ~ as.Date(price$date),type="l",col="blue",
  xlab="Date",ylab="DMI 45d",main="DMI",ylim=c(0,60))
...
plot(tail(dmi.adx[,1],200) ~ tail(as.Date(price$date),200),type="l",col="blue",
  xlab="Date",ylab="DMI",main="DMI 16d",ylim=c(10,40))
...
The 16-day DMI gave returns 22x the hodl ROI, which is no better than the moving average 
strategies which yielded returns around ~27x the hodl ROI.
