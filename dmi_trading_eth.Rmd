---
title: "ETH Trading based on Directional Movement Index (DMI)"
author: "Mark Ziemann"
date: "`r Sys.Date()`"
output:
  html_document:
...
price <- data.frame(price$time_close, price$quote$USD$high, price$quote$USD$low, price$quote$USD$close,strongsAsFactors=FALSE)
