---
title: "Trading ETH based on Directional Movement Index (DMI)"
...
Source: https://github.com/markziemann/cryptoblog/blob/main/dmi_trading_eth.Rmd
...
The 57 day interval gives a high probability of high returns but occurs rarely.
...
The 30 day interval gives a significantly higher overall return, but the mean return on trades is lower than the 57 day.
...
This is good indicator because the frequency is moderate and gains are still very good.
...
Personally, this is why I consider the 19 day interval the "best".
The 19-day DMI gave returns 190x the hodl ROI, which is significantly better than the moving average 
strategies which yielded returns around ~19x the hodl ROI.
