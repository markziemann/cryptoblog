---
title: "Trading ETH based on True Strength Indicator (TSI)"
...
Source: https://github.com/markziemann/cryptoblog/blob/main/tsi_trading_eth.Rmd
...
Here using the TSI we have a strategy which scored 822x hodl returns which is superior to the best directional movement indicator
(187x hodl) and best moving average strategy (19x hodl), albeit with more trades.
