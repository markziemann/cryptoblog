...
URL=paste("https://web-api.coinmarketcap.com/v1/cryptocurrency/ohlcv/historical?symbol=xx&convert=USD&interval=daily&time_start=2013-06-01&time_end=",mydate,sep="")
...
sma_dat <- c("indicator"="SMA",
  "parameter"=best_sma,
  "meanROI"= res_sma[which(rownames(res_sma)==best_sma),"mean"] ,
...
write.table(t(sma_dat),file=filename,append=TRUE)
write.table(t(ema_dat),file=filename,append=TRUE)
