---
title: "<br>Trading XMR based on weekly MA and EMAs"
date: "`r Sys.Date()`"
---

[Source code](https://github.com/MDZanalytics/cryptoblog/blob/main/ma_trading_weekly_xmr.Rmd)
...
Obtaining historical data (weekly) from CoinMarketCap.com from 2014 to present.
...
plot(x=myrange, y=res_sma$returns, pch=19,
  xlab="moving average interval (weeks)",ylab="fold return",main="Weekly SMA")
abline(h=hodl,col="red")
grid()

plot(x=myrange,y=res_ema$returns, pch=19,
  xlab="moving average interval (weeks)",ylab="fold return",main="Weekly EMA")
abline(h=hodl,col="red")
grid()
...
vioplot(sma_yearly,ylab="trade ROI distribution",main="Weekly SMA strategy")

yr <- sapply(sma_yearly,prod)
barplot(yr,ylab="yearly fold returns",main="Weekly SMA strategy")
...
vioplot(ema_yearly,ylab="trade ROI distribution",main="Weekly EMA strategy")

yr <- sapply(ema_yearly,prod)
barplot(yr,ylab="yearly fold returns",main="Weekly EMA strategy")
text(x=(1:length(yr)*1.2)-0.4,y=yr*0.9,labels=signif(yr,2),cex=1.2)
abline(h=1,col="red",lty=2)
